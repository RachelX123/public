...
<html lang="en">
    ...
    <?php
        ...
        //get user_comment
        $sql_user_forum="SELECT m.*,u.username,u.picture,t.user_type FROM forum as m LEFT JOIN user AS u on u.user_id=m.user_id LEFT JOIN user_type As t on u.user_type = t.user_type_id 
        where `type`='student' ORDER BY forum_id asc";
        $res=$conn->query($sql_user_forum);
        $user_forum_list=[];
        while($data=$res->fetch_assoc()){
            //Judgment is all about liking or canceling
           ...
           if($data['forum_pid']>0){
            ...
            if($topa['forum_pid']!=0){
            $sql="SELECT u.user_id,u.username,u.picture, t.user_type from `forum` as f left Join user as u on u.user_id=f.user_id left join user_type as t on u.user_type = t.user_type_id
            where forum_id={$data['forum_pid']}";
            $user=$conn->query($sql);
    ...
    ?>
        ...
        <div class="content_container" >
            ...
            <div class="creater" >
                ...
                <div class="showTitle" >
                    <h3>Student Forum</h3>
                    <p>Welcome to discuss student-related content in this forum</p>
                    <p>Hopefully it will help the student community help each other</p>
                </div>           
                <!--  -->           
            </div>
                                ...
                                <div class="user-forum">
                                    ...
                                    <div class="all_content" >
                                        <div class="text-content">
                                            ...
                                            <div class="ico">
                                                <i onclick="toLike(<?php echo $item['forum_id'];?>)"  class="bx 
                                                ...
                                                <?php 
                                                        ...
                                                        ?>
                                                "></i>
                                                <i onclick="toDislike(<?php echo $item['forum_id'];?>)"  class="bx 
                                                ...
                                                <div class="all_content" >
                                                    <div class="text-content">
                                                        <div class="content" ><?php echo $items['comment'];?></div>
                                                            <div class="ico">
                                                                <i onclick="toLike(<?php echo $items['forum_id'];?>)"  class="bx 
