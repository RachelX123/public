...
<html lang="en">
    ...
    <?php
        ...
        //get user_comment
        $sql_user_forum="SELECT m.*,u.username,u.picture FROM forum as m LEFT JOIN user AS u on u.user_id=m.user_id 
        ...
        while($data=$res->fetch_assoc()){
           ...
           if($data['forum_pid']>0){
            ...
            if($topa['forum_pid']!=0){
            $sql="SELECT u.* from `forum` as f left Join user as u on u.user_id=f.user_id 
