                    ...
                    <div class="row">
                        ...
                        <div class="col m6">
                            ...
                            <form action="addgenre.php" method="POST">
                                ...
                                <input id="box" type="text" name="genre" required="required" value="New Genre Name">
                                <input id="box" type="text" name="url" required="required" value="picture url for genre">
                                <a class="col m3"></a><input type="submit" value="SUBMIT" name="submit" class="col m6">
                            </form>
                        </div>
                    </div>
                            ...
                            ?>
                                <div class="row">
                                    <div class="col m12">
                                        ...
                                        <div class="col m1"><a href="<?php echo "editbook.php?id=$id&do=editbook"; ?>"><button>EDIT</button></a></div>
                                        <br>
                                    </div>
                                </div>
                                    ...
                                    ?>
                                        <div class="row">
                                            <div class="col m11">
                                                ...
                                                <div class="col m1"><a href="edituser.php?id=<?php echo "$user_id" ?>&do=account"><button>EDIT</button></a></div>
                                            </div>
                                        </div>
                                ...
                                ?>
                                    <div class="row">
                                        <div class="col m12">
                                            ...
                                            <div class="col m1"><a href="<?php echo "editreview.php?id=$id&do=review&title=$title"; ?>"><button>EDIT</button></a></div>
                                            <br>
                                        </div>
                                    </div>
